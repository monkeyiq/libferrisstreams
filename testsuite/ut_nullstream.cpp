...
*******************************************************************************
    ...
    $Id: ut_nullstream.cpp,v 1.2 2010/09/24 05:05:45 ben Exp $
...
const string PROGRAM_NAME = "ut_nullstream";
...
{
    NullStream<> ss;
    if( !( ss << "A bit of mindless waffle old chum" ))
        E() << "Failed to write to null stream!" << endl;
